...
describe("DeleteAccountSection", () => {
  ...
  it("shows the confirmation form when Delete Account button is clicked", async () => {
    ...
    expect(
      screen.getByLabelText(/Type "DELETE MY ACCOUNT" exactly/),
    ).toBeInTheDocument();
  });
  ...
  it("validates form inputs correctly", async () => {
    ...
    expect(
      screen.getByText("Please enter your exact email address"),
    ).toBeInTheDocument();
    expect(
      screen.getByText(/Please type "DELETE MY ACCOUNT" exactly/),
    ).toBeInTheDocument();
  ...
  it("shows success modal when account is deleted successfully", async () => {
    ...
    await user.type(
      screen.getByLabelText("Confirm Your Email"),
      "test@example.com",
    );
  ...
  it("handles errors when delete fails", async () => {
    ...
    (deleteUserAccount as jest.Mock).mockRejectedValueOnce(
    ...
    await waitFor(() => {
      ...
      expect(
        screen.queryByText("Account Deleted Successfully"),
      ).not.toBeInTheDocument();
    });
  });
  ...
  it("allows cancelling the deletion process", async () => {
    ...
    expect(
      screen.queryByLabelText("Confirm Your Email"),
    ).not.toBeInTheDocument();
    expect(
      screen.getByRole("button", { name: "Delete Account" }),
    ).toBeInTheDocument();
