...
export default function PasswordSection({ onError }: PasswordSectionProps) {
  ...
  const formStatus = useMemo(() => {
    ...
    const hasChanges = passwordForm.current_password.length > 0 ||
    ...
    const isValid = passwordForm.current_password.length > 0 &&
    ...
    <div className="bg-background rounded-lg p-6">
      ...
      <form onSubmit={handleUpdatePassword} className="space-y-4">
          ...
          <div className="relative">
            ...
            >
              {passwordVisibility.current_password ? (
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-default-500" viewBox="0 0 20 20" fill="currentColor">
          ...
          <div className="relative">
            <Input
              ...
              className={`w-full pr-10 ${
                ...
                (passwordForm.password && passwordForm.current_password && !formStatus.isDifferentPassword) 
                  ? 'border-danger' : ''
              }`}
              required
            />
        ...
        <div>
          ...
          {passwordForm.password_confirmation.length > 0 && !formStatus.passwordsMatch && (
            <p className="mt-1 text-xs text-danger">
       ...
       {passwordError && (
        ...
        <div className="pt-3 flex justify-end">
          <Button
            type="submit"
            color={formStatus.hasChanges && formStatus.isValid ? "success" : "default"}
            isLoading={isPasswordLoading}
            disabled={isPasswordLoading || !formStatus.hasChanges || !formStatus.isValid}
            className="ml-3"
          >
