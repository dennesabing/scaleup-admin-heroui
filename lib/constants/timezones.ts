...
export const timezones: TimezoneOption[] = [
  ...
  { value: "America/Phoenix", label: "Mountain Time (no DST)", offset: "UTC-07:00" },
  ...
  { value: "America/Toronto", label: "Eastern Time - Toronto", offset: "UTC-05:00" },
  { value: "America/Halifax", label: "Atlantic Time", offset: "UTC-04:00" },
  { value: "America/St_Johns", label: "Newfoundland Time", offset: "UTC-03:30" },
  { value: "America/Sao_Paulo", label: "Sao Paulo", offset: "UTC-03:00" },
  { value: "Europe/London", label: "London", offset: "UTC+00:00" },
  { value: "Europe/Berlin", label: "Central European Time", offset: "UTC+01:00" },
...
export const getTimezoneByLabel = (label: string): TimezoneOption | undefined => {
  return timezones.find(timezone => timezone.label.toLowerCase() === label.toLowerCase());
}; 