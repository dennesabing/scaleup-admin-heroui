...
const API_ENDPOINTS = {
  ...
  ORGANIZATION_MEMBER: (id: number | string, userId: number | string) =>
    `/organizations/${id}/members/${userId}`,
  ORGANIZATION_INVITATIONS: (id: number | string) =>
    `/organizations/${id}/invitations`,
  ORGANIZATION_TOKEN_GET: (organization_id: number | string, token: string) =>
    `/invitations/${organization_id}/${token}`,
  ORGANIZATION_TOKEN_ACCEPT: (
  ...
  ORGANIZATION_ATTRIBUTES: (id: number | string) =>
    `/organizations/${id}/attributes`,
  ORGANIZATION_ATTRIBUTE: (id: number | string, attribute: string) =>
    `/organizations/${id}/attributes/${attribute}`,
};
...
export const getOrganizationMembers = async (
  ...
  const response = await axiosInstance.get(
    API_ENDPOINTS.ORGANIZATION_MEMBERS(organizationId),
  );
...
export const updateOrganizationMember = async (
  ...
  const response = await axiosInstance.put(
    API_ENDPOINTS.ORGANIZATION_MEMBER(organizationId, userId),
    { role },
  );
...
export const createOrganizationInvitation = async (
  ...
  email: string,
  role: string,
): Promise<OrganizationInvitationModel> => {
  const response = await axiosInstance.post(
    API_ENDPOINTS.ORGANIZATION_INVITATIONS(organizationId),
    { email, role },
  );
...
export const cancelOrganizationInvitation = async (
  ...
  await axiosInstance.delete(
    API_ENDPOINTS.ORGANIZATION_INVITATION(organizationId, invitationId),
  );
};
...
export const getOrganizationAttributes = async (
  ...
  const response = await axiosInstance.get(
    API_ENDPOINTS.ORGANIZATION_ATTRIBUTES(organizationId),
  );
 ...
 */
export const createOrganizationAttributes = async (
  organizationId: number | string,
 ...
 */
export const updateOrganizationAttribute = async (
  organizationId: number | string,
  attribute: string,
  value: any,
): Promise<Record<string, any>> => {
  const response = await axiosInstance.put(
    API_ENDPOINTS.ORGANIZATION_ATTRIBUTE(organizationId, attribute),
    { value },
  );
 ...
 */
export const deleteOrganizationAttribute = async (
  organizationId: number | string,
  attribute: string,
): Promise<void> => {
  await axiosInstance.delete(
 ...
 */
export const deleteAllOrganizationAttributes = async (
  organizationId: number | string,
): Promise<void> => {
  await axiosInstance.delete(
    API_ENDPOINTS.ORGANIZATION_ATTRIBUTES(organizationId),
...
export const resendOrganizationInvitation = async (
  ...
  const response = await axiosInstance.post(
    `${API_ENDPOINTS.ORGANIZATION_INVITATION(organizationId, invitationId)}/resend`,
  );
