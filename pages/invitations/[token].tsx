...
const InvitationAcceptPage: NextPageWithLayout = () => {
  ...
  useEffect(() => {
    ...
    const orgId =
      queryOrgId && typeof queryOrgId === "string" ? queryOrgId : "";
      ...
      <div className="max-w-md w-full px-4">
        <Card className="shadow-lg">
          <CardHeader className="flex gap-3 pb-0">
            <BuildingIcon className="text-primary" size={36} />
            <div>
          ...
          <CardBody>
            {error && !invitation ? (
              <div className="py-6 text-center">
                <Mail className="mx-auto mb-3 text-danger" size={48} />
                  ...
                  <div className="border-b pb-4">
                    ...
                    <div className="space-y-2 text-sm">
                      ...
                      <div className="flex justify-between">
                        ...
                        <Tooltip
                          content={formatDateTime(invitation.updated_at)}
                        >
                          <span>
                            {formatRelativeTime(invitation.updated_at)}
                          </span>
                        </Tooltip>
                      </div>
                      <div className="flex justify-between">
                        ...
                        <Tooltip
                          content={formatDateTime(invitation.expires_at)}
                        >
                          <span>
                  ...
                  {invitation.status === "pending" ? (
                    <div className="bg-primary-50 p-3 rounded-lg">
                      <p className="text-sm text-primary-700">
                        {isAuthenticated ? (
                          <>
                            You can join this organization directly with your
                            existing account.
                          </>
                        ) : (
                          <>
                            By accepting this invitation, you will be redirected
                            to create an account with {invitation.email}.
                          </>
                        )}
                      </p>
                    </div>
                    ...
                    <div className="bg-danger-50 p-3 rounded-lg">
                      <p className="text-sm text-danger-700">
                        This invitation has expired. Please contact the
...
InvitationAcceptPage.getLayout = (page: ReactElement) => {
  return (
    <HeroUIProvider>
      <NextThemesProvider>{page}</NextThemesProvider>
    </HeroUIProvider>
  );
};
